...
from avalanche.training.strategies import Naive, CWRStar, Replay, GDumb, Cumulative, LwF, GEM, AGEM, EWC,JointTraining,SynapticIntelligence,CoPE, OWM, RAWM, RWM
...
for strate in method_query:
    for current_mode in ['offline']:
        ...
        if args.pretrain_feature=='None':
            ...
            # model=scnn(args.pretrain_feature_shape, args.num_classes)
